...
public class GetScheduleAttractionsByAttractionIdHandler : IRequestHandler<GetScheduleAttractionsByAttractionIdQuery, IEnumerable<ScheduleAttractionDto>>
{
    private readonly IScheduleAttractionRepository _scheduleAttractionRepository;

    public GetScheduleAttractionsByAttractionIdHandler(IScheduleAttractionRepository scheduleAttractionRepository)
    {
        _scheduleAttractionRepository = scheduleAttractionRepository;
    }

    public async Task<IEnumerable<ScheduleAttractionDto>> Handle(GetScheduleAttractionsByAttractionIdQuery request, CancellationToken cancellationToken)
    {
        var scheduleAttractions = await _scheduleAttractionRepository.GetByAttractionIdAsync(request.AttractionId, cancellationToken);
