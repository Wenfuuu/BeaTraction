...
export default function AdminDashboardPage() {
  ...
  const totalRegistrations = stats.reduce((sum, stat) => sum + stat.totalRegistrations, 0)
  const overallUtilization = getUtilizationPercentage(totalRegistrations, totalCapacity)
  ...
  return (
    <AdminLayout>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Real-time registration monitoring</p>
      </div>
            ...
            <Card key={attraction.attractionId}>
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <div className={`text-sm font-semibold ${getUtilizationColor(utilization)}`}>
              ...
              <CardContent>
                <div className="space-y-4">
                  <h4 className="font-semibold text-sm text-gray-700">Schedule Breakdown:</h4>
                  {attraction.schedules.map((schedule) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div>
                            <h5 className="font-semibold">{schedule.scheduleName}</h5>
                          ...
                          <div className="text-right">
                            <div className="font-semibold">
                              {schedule.registrationCount} / {attraction.capacity}
                            </div>
                            <div className={`text-sm ${getUtilizationColor(scheduleUtilization)}`}>
                              {scheduleUtilization}%
                            </div>
                          </div>
                        </div>
                        ...
                        {scheduleUtilization >= 90 && (
                          <div className="flex items-center gap-2 text-sm text-red-600 bg-red-50 p-2 rounded">
                            ...
                            <span>Nearly full! Only {attraction.capacity - schedule.registrationCount} spots left</span>
                          </div>
                        )}
                      </div>
                    )
